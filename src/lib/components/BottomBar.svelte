...
<!-- Outer container to position panel above bar -->
<div class="relative w-full">
	<!-- Settings Panel -->
	{#if showSettings}
		<div
			class="absolute bottom-full left-0 mb-2 w-full max-w-full rounded-t-2xl bg-gray-900/70 backdrop-blur-lg shadow-xl p-4 border border-gray-700 transition-transform duration-200"
	...
	<!-- Bottom Bar -->
	<div class="flex justify-center space-x-4 p-4 bg-black/60 backdrop-blur-md rounded-t-2xl">
